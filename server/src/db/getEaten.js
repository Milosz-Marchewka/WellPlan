...
export const getEaten = async({email}, res)=>{
    ...
    try{
        ...
        const percentages = {
            ...
            proteins: eaten?.proteins == null ? 0 : Math.round((eaten?.proteins || 0 / ceil?.proteins) * 100),
            fat: eaten?.fat == null ? 0 : Math.round((eaten?.fat || 0 / ceil?.fat) * 100),
            carbs: eaten?.carbs == null ? 0 : Math.round((eaten?.carbs || 0 / ceil?.carbs) * 100)
        }
