...
const Home = ({user, eaten, setEaten, fetchEaten})=>{
    ...
    const fetchEvents = async (email, date)=>{
        try{
            ...
            const req = await fetch(`https://api-wellplan.vercel.app/calendar/get?email=${email}&date=${formatted}`, {
                method: "GET",
                headers:{
    ...
    const fetchTraining = async (email)=>{
        ...
        try{
            const req = await fetch(`https://api-wellplan.vercel.app/training/get?email=${email}`, {
                method: "GET"
            })
